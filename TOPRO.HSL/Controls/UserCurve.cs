...
namespace HslCommunication.Controls
{
    ...
    public partial class UserCurve : UserControl
    {
        ...
        public void SetLeftCurve( string key, float[] data, Color lineColor,float thickness=1f)
        {
        ...
        /// <param name="lineColor"></param>
        /// <param name="thickness"></param>
        public void SetRightCurve( string key, float[] data, Color lineColor, float thickness = 1f)
        {
            SetCurve( key, false, data, lineColor, thickness);
        }
