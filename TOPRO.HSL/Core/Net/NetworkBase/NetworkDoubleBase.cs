...
namespace HslCommunication.Core.Net
{
    ...
    /// </example>
    public class NetworkDoubleBase<TNetMessage, TTransform> : NetworkBase, INetConnection where TNetMessage : INetMessage, new() where TTransform : IByteTransform, new()
    {
        #region Constructor
        ...
        /// <returns></returns>
        protected OperateResult<string> GetStringResultFromBytes(OperateResult<byte[]> result,Encoding encode)
        {
            return ByteTransformHelper.GetStringResultFromBytes(result, byteTransform, encode);
        }
