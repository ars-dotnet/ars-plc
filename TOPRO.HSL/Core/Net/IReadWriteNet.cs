...
namespace HslCommunication.Core
{
    ...
    /// </example>
    public interface IReadWriteNet : INetOperation
    {
        #region Read Support
        ...
        /// <returns>带有成功标识的string数据</returns>
        OperateResult<string> ReadString(string address, ushort length, Encoding encode);
        ...
        /// <param name="encode"></param>
        /// <returns>带有成功标识的结果类对象</returns>
        OperateResult Write(string address, string value, Encoding encode);
        ...
        /// <param name="encode"></param>
        /// <returns>带有成功标识的结果类对象</returns>
        OperateResult Write(string address, string value, int length,Encoding encode);
