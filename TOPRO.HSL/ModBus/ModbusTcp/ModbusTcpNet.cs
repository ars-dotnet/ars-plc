...
namespace TOPRO.HSL.ModBus
{
    ...
    /// </example>
    public class ModbusTcpNet : NetworkDeviceBase<ModbusTcpMessage, ReverseWordTransform>, IModbusNetOperation, IModbusReadWriteNet
    {
        #region Constructor
        ...
        {
            return ReadCoil(address, length);
        }
